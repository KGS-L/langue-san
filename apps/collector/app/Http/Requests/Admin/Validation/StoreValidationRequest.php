...
class StoreValidationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $maxCorrectionLength = $contribution?->prompt?->type === PromptType::NARRATIVE ? 20000 : 5000;

        return [
            'decision' => ['required', Rule::enum(ValidationDecision::class)],
            'san_text_corrected' => ['nullable', 'required_if:decision,correct', 'string', 'max:'.$maxCorrectionLength],
