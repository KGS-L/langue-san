...
{
    protected $fillable = ['user_id', 'category_id', 'status', 'started_at', 'completed_at'];
    protected function casts(): array { return ['status' => CollectionSessionStatus::class, 'started_at' => 'datetime', 'completed_at' => 'datetime']; }
